...
.wf-tree-checkbox:hover:not(:checked):not(:indeterminate):not(:disabled) {
  border-color: #38bdf8;
  background-color: #f0f9ff;
  box-shadow: 0 0 0 2px rgba(14, 165, 233, 0.12);
}

.wf-tree-checkbox:checked:hover:not(:disabled),
.wf-tree-checkbox:indeterminate:hover:not(:disabled) {
  border-color: #0284c7;
  background-color: #0284c7;
  box-shadow: 0 2px 6px rgba(14, 165, 233, 0.35);
}

.wf-tree-checkbox:checked {
  border-color: #0ea5e9;
...
.wf-tree-checkbox:indeterminate {
  border-color: #0ea5e9;
  background-color: #0ea5e9;
...
.wf-tree-checkbox:focus-visible {
  border-color: #0ea5e9;
  box-shadow: 0 0 0 3px rgba(14, 165, 233, 0.22);
}

.wf-tree-checkbox:disabled {
  opacity: 0.45;
  cursor: not-allowed;
